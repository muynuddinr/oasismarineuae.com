...
export default function ProductDetail({
 ...
 // Enhanced download function with better error handling and image processing
    ...
    if (product.specifications && Object.keys(product.specifications).length > 0) {
      ...
      if (tableData.length > 0) {
        ...
        tableData.forEach((row, index) => {
          ...
          const value = row[1].toString().length > 30 ? row[1].toString().substring(0, 27) + '...' : row[1].toString();
